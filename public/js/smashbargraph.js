...
$(document).ready(function() {
	...
	var tableData = {
		...
		// Round off the value
//		var chartMax = Math.ceil(Math.max.apply(Math, chartData) / scaleOrder) * scaleOrder;
		var chartMax = Math.ceil(Math.max.apply(Math, chartData));
		return chartMax;
	    },
...
//		    yLegend.unshift(((chartYMax * i) / (yAxisMarkings - 1)) / scaleOrder);
